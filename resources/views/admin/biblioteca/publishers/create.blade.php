...
<div class="max-w-[960px] mx-auto">
    ...
    <div class="mb-6 flex items-start gap-4">
        ...
        <div>
            <div class="flex items-center gap-3 flex-wrap">
                <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Agregar nueva editorial</h2>
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Completa los campos y guarda para registrar la nueva editorial.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.biblioteca.publishers.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-5 flex gap-3 justify-end">
            ...
            <button type="submit"
                class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-medium shadow-lg shadow-emerald-500/20 transition-all">Guardar editorial</button>
        </div>
    </form>
</div>
@endsection
