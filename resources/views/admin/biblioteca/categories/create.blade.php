...
<div class="p-6 md:p-10 max-w-[720px] mx-auto">
    ...
    <form action="{{ route('admin.biblioteca.categories.store') }}" method="POST">
        ...
        <div class="mt-6 flex gap-3 justify-end">
            ...
            <button type="submit"
                class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold shadow-lg shadow-emerald-200 transition-all">Guardar categoría</button>
        </div>
    </form>
</div>
@endsection
