...
@section('section', 'Biblioteca > 1er Nivel Revistas > Editar')
...
<div class="max-w-[600px] mx-auto">
    ...
    <div class="mb-6 flex items-start gap-4">
        ...
        <div>
            <div class="flex items-center gap-3 flex-wrap">
                <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Editar 1er Nivel de Revista</h2>
    ...
    <form action="{{ route('admin.biblioteca.revista-firstlevels.update', $category) }}" method="POST">
        @csrf @method('PUT')
