...
<div class="p-6 md:p-10 max-w-[960px] mx-auto">
    ...
    <div class="flex items-start gap-4 mb-8">
        ...
        <div>
            ...
            <p class="text-slate-500 text-sm mt-1">Completa los campos y guarda para registrar el nuevo libro.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.biblioteca.books.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-6 flex gap-3 justify-end">
            ...
            <button type="submit"
                class="px-6 py-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold shadow-lg shadow-emerald-200 transition-all">Guardar libro</button>
        </div>
    </form>
</div>
<script>
