    ...
    <div class="mb-6 flex items-start gap-4">
        ...
        <div>
            <div class="flex items-center gap-3 flex-wrap">
                ...
                <span class="inline-flex items-center px-2.5 py-1 rounded-md text-[11px] font-medium bg-brand-50 text-brand-600 dark:bg-brand-500/10 dark:text-brand-400 border border-brand-100 dark:border-brand-500/20">NIVEL 1</span>
            </div>
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Categoría principal de la Fototeca. Sin padre.</p>
        </div>
    </div>
