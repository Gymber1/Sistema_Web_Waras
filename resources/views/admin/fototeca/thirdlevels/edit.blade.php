...
@section('section', 'Fototeca > 3er Nivel > Editar')
...
<div class="max-w-[600px] mx-auto">
    ...
    <div class="mb-6 flex items-start gap-4">
        ...
        <div>
            <div class="flex items-center gap-3 flex-wrap">
                <h2 class="text-2xl font-bold text-slate-800 dark:text-white">Editar 3er Nivel</h2>
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Modifica el nombre o el 2do nivel padre y guarda los cambios.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.fototeca.thirdlevels.update', $category) }}" method="POST">
        @csrf @method('PUT')
