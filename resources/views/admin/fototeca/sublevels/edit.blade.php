...
@section('section', 'Fototeca > SubNivel > Editar')
...
<div class="p-6 md:p-10 max-w-[720px] mx-auto">
    ...
    <div class="flex items-start gap-4 mb-8">
        ...
        <div>
            <div class="flex items-center gap-3 flex-wrap">
                <h1 class="text-2xl font-black text-slate-900">Editar SubNivel</h1>
                <span class="px-3 py-1 bg-indigo-100 text-indigo-700 text-xs font-bold rounded-full uppercase tracking-wider">NIVEL 3</span>
            </div>
            <p class="text-slate-500 text-sm mt-1">Modifica el nombre o la subcategoría padre y guarda los cambios.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.fototeca.sublevels.update', $category) }}" method="POST">
        ...
        <div class="mt-6 flex gap-3 justify-end">
            ...
            <button type="submit"
                class="px-6 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-bold shadow-lg shadow-indigo-200 transition-all">Guardar cambios</button>
        </div>
    </form>
</div>
@endsection
