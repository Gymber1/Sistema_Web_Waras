...
<div class="max-w-[720px] mx-auto">
    ...
    <div class="mb-6 flex items-start gap-4">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Completa los campos y guarda para registrar el nuevo donador.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.fototeca.donors.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="bg-white dark:bg-dark-surface rounded-xl shadow-premium dark:shadow-premium-dark border border-slate-200/50 dark:border-dark-border p-6 md:p-8 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="biography" rows="4" placeholder="Datos biográficos del donador..."
        ...
        <div class="mt-5 flex gap-3 justify-end">
            ...
            <button type="submit"
                class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg text-sm font-medium shadow-lg shadow-emerald-500/20 transition-all">Guardar donador</button>
        </div>
    </form>
</div>
<script>
