...
@section('section', 'Fototeca > SubCategoría > Nueva')
...
<div class="p-6 md:p-10 max-w-[720px] mx-auto">
    ...
    <div class="flex items-start gap-4 mb-8">
        ...
        <div>
            ...
            <p class="text-slate-500 text-sm mt-1">Elige la categoría principal a la que pertenece esta subcategoría.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.fototeca.subcategories.store') }}" method="POST">
        ...
        <div class="mt-6 flex gap-3 justify-end">
            ...
            <button type="submit"
                class="px-6 py-3 bg-cyan-600 hover:bg-cyan-700 text-white rounded-xl font-bold shadow-lg shadow-cyan-200 transition-all">Guardar subcategoría</button>
        </div>
    </form>
</div>
@endsection
