                ...
                <div class="mb-8">
                    ...
                    <details class="group mb-1.5" {{ request()->routeIs('admin.biblioteca.*') ? 'open' : '' }}>
                        ...
                        <div class="ml-11 mt-2 flex flex-col gap-1 border-l-2 border-slate-700/50 pl-3">
                            ...
                            <a href="{{ route('admin.biblioteca.categories') }}" class="text-left text-[13px] font-medium px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.biblioteca.categories*') && !request()->routeIs('admin.biblioteca.subcategories*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}">Categorías</a>
                            <a href="{{ route('admin.biblioteca.subcategories') }}" class="text-left text-[13px] font-medium px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.biblioteca.subcategories*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}">SubCategorías</a>
                            ...
                            <a href="{{ route('admin.biblioteca.specials.assign-books') }}" class="text-left text-[13px] font-medium px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.biblioteca.specials.assign-books') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}">Agregar a Especiales</a>
                            <a href="{{ route('admin.biblioteca.descriptors') }}" class="text-left text-[13px] font-medium px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.biblioteca.descriptors*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}">Descriptores</a>
                        </div>
                    </details>
                    @endif
                    ...
                    <details class="group mb-1.5" {{ request()->routeIs('admin.fototeca.*') ? 'open' : '' }}>
                        ...
                        <div class="ml-11 mt-2 flex flex-col gap-1 border-l-2 border-slate-700/50 pl-3">
                            <a href="{{ route('admin.fototeca.photos') }}" class="text-left text-[13px] font-medium px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.fototeca.photos*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}">Fotos</a>
