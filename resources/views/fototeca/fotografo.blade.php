        ...
        <div class="header-container">
            ...
            <nav>
                <ul class="nav-menu">
                    ...
                    <li><a href="{{ route('fototeca.dashboard') }}#Fotógrafos" class="nav-item active">Fotógrafos</a></li>
                    <li><a href="{{ route('fototeca.dashboard') }}#Especiales" class="nav-item">Especiales</a></li>
                    <li><a href="{{ route('fototeca.dashboard') }}#Aportantes" class="nav-item">Aportantes</a></li>
                </ul>
            </nav>
        </div>
    </header>
