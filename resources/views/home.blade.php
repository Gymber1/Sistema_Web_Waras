...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,600&display=swap" rel="stylesheet" media="print" onload="this.media='all';this.onload=null">
    <noscript><link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400;1,600&display=swap" rel="stylesheet"></noscript>
        ...
        <section class="hero-section" id="inicio">
            ...
            <div class="scroll-indicator">
                <svg viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M5 9l7 7 7-7" />
                </svg>
            </div>
        </section>
                        ...
                        <div>
                            ...
                            <div style="display:flex;align-items:center;gap:.75rem;margin-bottom:1.5rem;">
                                <div style="width:36px;height:36px;background:rgba(205,162,116,.12);border-radius:8px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
                                    ...
                                    <svg width="18" height="18" fill="none" stroke="#cda274" stroke-width="2" viewBox="0 0 24 24">
                                    ...
                                    <svg width="18" height="18" fill="none" stroke="#cda274" stroke-width="2" viewBox="0 0 24 24">
                                        <path d="M17 8C8 10 5.9 16.17 3.82 19.23A2 2 0 0 0 5.59 22c5.26-1.34 9.29-4.28 11.41-8.67C18 11 17.63 8.63 17 8z" />
                                        <path d="M3.82 19.23C3 20.23 2 21 2 21s0-6 5-10c1.35-1.08 3-1.67 5-2" />
                                    </svg>
