...
<div style="position:fixed;bottom:1.5rem;right:1.5rem;z-index:9999;display:flex;flex-direction:column;gap:0.75rem;align-items:flex-end;">
    ...
    <div style="position:relative;" id="fb-yape-wrap">
        ...
        <div id="fb-yape-popover"
             style="display:none;position:absolute;bottom:70px;right:0;background:white;border-radius:14px;box-shadow:0 20px 60px rgba(0,0,0,.2);padding:1.25rem;width:240px;text-align:center;z-index:10000;">
            <div style="font-size:.7rem;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:#742364;margin-bottom:.75rem;">Yape</div>
            @if($yapeUrl)
                <img src="{{ $yapeUrl }}" alt="QR Yape" style="width:200px;height:200px;object-fit:contain;border-radius:8px;border:1px solid #f3e8ff;">
            @else
                <div style="width:200px;height:200px;background:#f9f0ff;border-radius:8px;display:flex;align-items:center;justify-content:center;border:1px dashed #d8b4fe;">
            ...
            <div style="margin-top:.85rem;font-size:.85rem;font-weight:600;color:#222;line-height:1.5;">
                Con tu generoso aporte <span style="color:#742364;">podremos seguir publicando más</span> <span style="color:#c5a66d;">libros ancashinos.</span>
            </div>
    ...
    <div style="position:relative;" id="fb-wa-wrap">
        ...
        <div id="fb-whatsapp-popover"
            ...
            @if($waUrl)
                <img src="{{ $waUrl }}" alt="QR WhatsApp" style="width:200px;height:200px;object-fit:contain;border-radius:8px;border:1px solid #dcfce7;">
            @else
                <div style="width:200px;height:200px;background:#f0fdf4;border-radius:8px;display:flex;align-items:center;justify-content:center;border:1px dashed #86efac;">
